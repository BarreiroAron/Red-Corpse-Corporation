...
por cada turno que no se tire ninguna carta, su contador aumenta en 30 */
	...
	public Sonambulo() {
		super(0, 0, Habilidad.TIRAR_CARTA_ALEATOREA, new Imagen(Recursos.SONAMBULO), false, 0, 0, "Esta carta, al ser robada te obliga en los siguientes tres turnos a: jugar una carta aleatoria (que el juego decida). "
