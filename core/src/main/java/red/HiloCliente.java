...
public class HiloCliente extends Thread{
	...
	private void procesarMensaje(DatagramPacket dp) {
		...
		if(msg.equals("OK")) {
			...
			// aca poddemos poner algo que se haga true para empezar la partida, por ejemplo que todos los jugaadores
			//esten conectados y eso haga un true en juego para iniciar la partida
